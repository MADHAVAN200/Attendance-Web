                                ...
                                <div className="space-y-4">
                                    ...
                                    {correctionHistory.length === 0 ? (
                                        ...
                                        correctionHistory.map(req => (
                                            <div key={req.acr_id} className="bg-white dark:bg-dark-card p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex justify-between items-center">
                                                <div>
                    ...
                    <div className="fixed inset-0 z-[9000] flex items-center justify-center p-4 transition-all duration-200">
                        ...
                        <div className="relative w-full max-w-4xl space-y-8 animate-in fade-in zoom-in-95 duration-200">
                            ...
                            <div className="flex justify-center gap-6 pt-2">
                                {!imgSrc ? (
                                    <div className="flex justify-center gap-6 pt-2 relative">
                                        <button
                                            onClick={capture}
