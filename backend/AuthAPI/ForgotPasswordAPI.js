...
const emailService = {
  generateOTP: () => "123456",
  sendOTP: async (email, otp) => { console.log("MOCK OTP SENT to", email, otp); return { success: true }; },
  generateResetToken: () => "mock-reset-token",
  sendPasswordResetConfirmation: async (email) => { console.log("MOCK RESET CONFIRM SENT to", email); return { success: true }; }
};
